...
function Privacy() {
  return (
    <React.Fragment>
      <Container className="privacyContainer" style={{ width: "60%" }}>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to GrocerRia.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to GrocerRia, accessible from{" "}
              <a
                href="https://www.grocerria.com/"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://www.grocerria.com/
              </a>
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>By email: my.grocerria@gmail.com</li>
        </ul>
      </Container>
      <Footer />
    </React.Fragment>
